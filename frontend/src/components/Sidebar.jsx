...
export default function Sidebar({ activeTab, onTabChange }) {
  const menuItems = [
    ...
    { id: "employees", label: "Employees", icon: Users, color: "from-purple-500 to-pink-500" },
    { id: "attendance", label: "Attendance", icon: CalendarCheck, color: "from-orange-500 to-red-500" },
    { id: "leaves", label: "Leaves", icon: Calendar, color: "from-green-500 to-emerald-500" },
    // { id: "payroll", label: "Payroll", icon: DollarSign, color: "from-yellow-500 to-amber-500" },
  ];
